...
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ Good bye brother.හැබැයි උබ හිටිය කියල ඇති වැඩකුත් නැහැ ගියපු එකමයි හොද*\n*╚══════════════*'
conn.spromote = '*@user Good luck You are promoted කරන වැඩ හරියට කරපං දැන් 👍✨️☯️!!*'
conn.sdemote = '*@user උබ කරපු බලු වැඩ වලට තමා මෙහෙම කරේ පල යන්න මේ ගෲප් එකෙන්...!!*'
